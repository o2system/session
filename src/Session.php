...
class Session implements \ArrayAccess, \IteratorAggregate, LoggerAwareInterface
{
	 ...
	 * Session::__construct
	 *
	 * @param Core\Metadata\Config $config
	 *
	 * @return Session
	 */
	...
	public function markFlash( $offset )
	{
		if ( is_array( $offset ) )
		{
			...
			$_SESSION[ '__o2sessionVariables' ] = isset( $_SESSION[ '__o2sessionVariables' ] ) ? array_merge( $_SESSION[ '__o2sessionVariables' ], $new ) : $new;
	...
	public function unsetFlash( $offset )
	{
		...
		{
			if ( isset( $_SESSION[ '__o2sessionVariables' ][ $key ] ) && ! is_int( $_SESSION[ '__o2sessionVariables' ][ $key ] ) )
			{
	...
	public function markTemp( $offset, $ttl = 300 )
	{
		...
		if ( is_array( $offset ) )
		{
			...
			$_SESSION[ '__o2sessionVariables' ] = isset( $_SESSION[ '__o2sessionVariables' ] ) ? array_merge( $_SESSION[ '__o2sessionVariables' ], $temp ) : $temp;
